...
/*
    ...
    {
        DJIMissionManager mmManger=DJIMissionManager.getInstance();

        DJIFollowMeMission mFollowMe=new DJIFollowMeMission(34.5,56.7,20);
        mmManger.prepareMission(mFollowMe, new DJIMission.DJIMissionProgressHandle(){
